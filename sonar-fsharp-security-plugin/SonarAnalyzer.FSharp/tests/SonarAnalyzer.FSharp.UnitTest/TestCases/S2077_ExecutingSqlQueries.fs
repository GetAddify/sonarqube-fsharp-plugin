...
//         setting: SqlCommandColumnEncryptionSetting
//     ) =
...
//         RelationalDatabaseFacadeExtensions.ExecuteSqlCommand(
//             context.Database,
//             sprintf "SELECT * FROM mytable WHERE mycol=%O%O" x guid
//         ) // Noncompliant
...
//         context
//             .Query<User>()
//             .FromSql(sprintf "%O" parameters) // Noncompliant FP, interpolated string with argument tranformed in RawQuery
...
//         context
//             .Query<User>()
//             .FromSql("" + query, parameters) // Noncompliant
...
//         let formatted =
//             String.Format("INSERT INTO Users (name) VALUES (\"{0}\")", parameters)
...
//         context
//             .Query<User>()
//             .FromSql(String.Concat(query, parameters)) // Noncompliant

//         context
//             .Query<User>()
//             .FromSql(String.Format("INSERT INTO Users (name) VALUES (\"{0}\")", parameters)) // Noncompliant
...
//         let command =
//             SqlCommand(query, connection, transaction, SqlCommandColumnEncryptionSetting.Enabled) // Compliant

//         let command =
//             SqlCommand("", connection, transaction, SqlCommandColumnEncryptionSetting.Enabled) // Compliant, constant queries are safe
...
//     member this.NonCompliant_Concat_SqlCommands
//         (
//             connection: DbConnection,
//             transaction: DbTransaction,
//             query: string,
...
//         let command =
//             SqlCommand(String.Concat(query, param), connection, transaction, SqlCommandColumnEncryptionSetting.Enabled) // Noncompliant
...
//         let command =
//             SqlCommand(String.Format("INSERT INTO Users (name) VALUES (\"{0}\")", param)) // Noncompliant {{Make sure that executing SQL queries is safe here.}}
//         //                        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
//         let command =
//             SqlCommand(String.Format("INSERT INTO Users (name) VALUES (\"{0}\")", param), connection) // Noncompliant

//         let command =
//             SqlCommand(String.Format("INSERT INTO Users (name) VALUES (\"{0}\")", param), connection, transaction) // Noncompliant

//         let command =
//             SqlCommand(
//                 String.Format("INSERT INTO Users (name) VALUES (\"{0}\")", param),
//                 connection,
//                 transaction,
...
//         let command =
//             SqlCommand(
//                 String.Format("INSERT INTO Users (name) VALUES (\"{0}\", \"{2}\", \"{3}\")", x, g, dateTime), // Noncompliant - scalars can be dangerous and lead to expensive queries
//                 connection,
//                 transaction,
//                 SqlCommandColumnEncryptionSetting.Enabled
//             )
...
//         let command =
//             SqlCommand(
//                 String.Format("INSERT INTO Users (name) VALUES (\"{0}\", \"{2}\", \"{3}\")", x, param, dateTime), // Noncompliant
//                 connection,
//                 transaction,
//                 SqlCommandColumnEncryptionSetting.Enabled
//             )
...
//         let adapter =
//             SqlDataAdapter(String.Format("INSERT INTO Users (name) VALUES (\"{0}\")", param), "") // Noncompliant

//         ()


//     member this.NonCompliant_Interpolation_SqlCommands
//         (
//             connection: DbConnection,
//             transaction: DbTransaction,
//             param: string
...
//         let command =
//             SqlCommand(
//                 sprintf "SELECT * FROM mytable WHERE mycol=%O" param,
//                 connection,
//                 transaction,
//                 SqlCommandColumnEncryptionSetting.Enabled
//             ) // Noncompliant
...
//         let adapter =
//             SqlDataAdapter(sprintf "SELECT * FROM mytable WHERE mycol=%O" param, "") // Noncompliant
...
//     member this.NonCompliant_OdbcCommands
//         (
//             connection: DbConnection,
//             transaction: DbTransaction,
//             query: string,
...
//         let adapter =
//             OdbcDataAdapter(String.Format("INSERT INTO Users (name) VALUES (\"{0}\")", param), "") // Noncompliant
...
//     member this.NonCompliant_OracleCommands
//         (
//             connection: DbConnection,
//             transaction: DbTransaction,
//             query: string,
...
//         ) =
//         let command =
//             OracleCommand(String.Format("INSERT INTO Users (name) VALUES (\"{0}\")", param)) // Noncompliant {{Make sure that executing SQL queries is safe here.}}

//         command.CommandText <- sprintf "SELECT * FROM mytable WHERE mycol=%O" param // Noncompliant

//         let adapter =
//             OracleDataAdapter(String.Format("INSERT INTO Users (name) VALUES (\"{0}\")", param), "") // Noncompliant
...
//     member this.NonCompliant_SqlCeCommands
//         (
//             connection: DbConnection,
//             transaction: DbTransaction,
//             query: string,
